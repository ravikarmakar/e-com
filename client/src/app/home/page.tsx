...
const Home = () => {
  ...
  const { fetchBanners, fetchFeaturedProducts, banners, featuredProducts } =
    useSettingsStore();
          ...
          >
            ...
            <div className="relative h-full container mx-auto px-4 flex items-center">
              <div className="text-white space-y-6">
                ...
                <Button className="bg-white cursor-pointer text-black hover:bg-gray-100 px-8 py-6 text-lg">
                  SHOP NOW
                </Button>
              </div>
            </div>
